...
public final class BooleanTopicTile extends VBox {
    ...
    private final Function<Boolean, String> formatter;
    private final boolean defaultValue;

    public BooleanTopicTile(
        ...
        // create initial subscription and show initial topic in subtitle
    ...
    public void setTopic(String newTopicPath) {
        ...
        sub = inst.getBooleanTopic(topicPath).subscribe(defaultValue);
    ...
    private ContextMenu buildContextMenu() {
        ...
        setTopic.setOnAction(e -> {
            ...
            dialog.setHeaderText("Enter a NetworkTables boolean topic path");
